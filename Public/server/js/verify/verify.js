...
(
	function(window, undefined)
	{
		...
		verify.tip = function(name, val, style)
		{
			...
			{
				tip.innerHTML = val;
				tip.style.cssText = 'height:25px;line-height:25px;margin:0 0 0 3px;padding:4px 0 13px 25px;color:#999999;background:url('+verify.filePath()+style+'.gif) no-repeat 0 2px;';
			}
		}
