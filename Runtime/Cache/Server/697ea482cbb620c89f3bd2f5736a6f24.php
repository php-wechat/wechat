				...
				<tr>
					...
					<td colspan="3" class="lt">
						<select name="gid" style="width:136px;height:30px;">
							<?php if(is_array($group)): $i = 0; $__LIST__ = $group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option style="height:30px;" value="{viicms:$vo.id}" <?php if(($vo["id"]) == $info["gid"]): ?>selected="selected"<?php endif; ?> >{viicms:$vo.name}</option><?php endforeach; endif; else: echo "" ;endif; ?>
						</select>
					</td>
				</tr>				
				<tr>
					...
					<td colspan="3" class="lt">
						<input type="text" name="name" class="ipt" size="45" value="{viicms:$info.name}">
					</td>
				</tr>
				<tr>
					<td height="48" align="right"><strong>模块方法名称：</strong></td>
					<td colspan="3" class="lt">
						<input type="text" name="funname" class="ipt" size="45" value="{viicms:$info.funname}">
					</td>
				</tr>
				<tr>
					<td height="48" align="right"><strong>功能说明：</strong></td>
					<td colspan="3" class="lt">
						<textarea type="text" name="info" value="" class="ipt" style="width:450px;height:60px;margin:5px 0 5px 0;">{viicms:$info.info}</textarea>
					</td>
				</tr>
	<tr>
