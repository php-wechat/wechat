...
<div id="artlist">
    <div class="mod kjnav">
        <a href="<?php echo U('Users/add');?>">创建用户</a>
        <a href="<?php echo U('Users/index');?>">用户列表</a>
    </div>
</div>
<div class="cr"></div>
<div id="artlist">
	 ...
	 <div class="ksearch">
    	<div class="fl">
			<form action="{viicms::U('Users/search')}" method="post">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="alist">
	  <tr>
	    ...
	    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td >{viicms:$vo.username}</td>
				<td >{viicms:$group[$vo['gid']]}</td>
				<td align='center'>{viicms:$vo.lastip}</td>
				...
				<td align='center'>
					<a href="{viicms::U('Users/edit/',array('id'=>$vo['id']))}">修改</a>
					| <?php if(($vo["username"]) == "admin"): ?><font color="#cccccc">删除</font><?php else: ?><a href="javascript:void(0)" onclick="return confirmurl('{viicms::U('Users/del/',array('id'=>$vo['id']))}','确定删除该用户吗?')">删除</a><?php endif; ?>
				</td>
