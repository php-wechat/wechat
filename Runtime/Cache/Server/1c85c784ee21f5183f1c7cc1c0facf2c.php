  ...
  <tr>
    ...
    <div class="tm">
    	<ul>
        	...
        	<li class="nav curr" id="link{viicms:$nav_val['id']}">
			<a href="<?php echo U('System/menu',array('nav_id'=>1));?>" target="left">站点设置</a></li>

            <li class="nav" id="link{viicms:$nav_val['id']}">
                <a href="<?php echo U('System/menu',array('nav_id'=>2));?>" target="left">用户管理</a></li>

            <li class="nav" id="link{viicms:$nav_val['id']}">
                <a href="<?php echo U('System/menu',array('nav_id'=>3));?>" target="left">内容管理</a></li>

            <li class="nav" id="link{viicms:$nav_val['id']}">
                <a href="<?php echo U('System/menu',array('nav_id'=>4));?>" target="left">公总号管理</a></li>

            <li class="nav" id="link{viicms:$nav_val['id']}">
                <a href="<?php echo U('System/menu',array('nav_id'=>5));?>" target="left">功能模块</a></li>

            <li class="nav" id="link{viicms:$nav_val['id']}">
                <a href="<?php echo U('System/menu',array('nav_id'=>6));?>" target="left">扩展管理</a></li>
        </ul>
    </div>
<div class="topnav">
