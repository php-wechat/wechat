...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
  <tr>
	...
	<tr> 
      ...
      <td><input type="text" name="name" value="{viicms:$info.name}" class="ipt" size="45" /></td>
    </tr>
	<tr> 
	...
	<tr> 
      ...
      <td><input type="text" name="remark" value="{viicms:$info.remark}"  class="ipt" size="45" /></td>
    </tr>
    <tr> 
      <td height="48" colspan="2"><div id="addkey"></div><div class="fabu"><img src="{viicms::RES}/images/main/addwz.gif" id="submit" /> <img src="{viicms::RES}/images/main/addqx.gif" /></div></td>
    </tr>
</table>
</form>
<br />
